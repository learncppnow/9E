...
int main()
{
   ...
   cout << "Erasing the range of pairs with 1000 as key.\n";
   ...
   cout << " key-value pair(s)."<< "They are: \n";
   DisplayContents(mmapIntToStr);
